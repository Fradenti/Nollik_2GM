...
Rcpp::sourceCpp(here::here("Riprova_corretta_W4"))
source(here::here("Riprova_correttaW4.R"))
...
###########################################################################
  ...
  clusterEvalQ(cl,expr = {
    Rcpp::sourceCpp(here::here("Riprova_corretta_W4.cpp"))
    source(here::here("Riprova_correttaW4.R"))
...
############################################################## Scenario 1
  ...
  clusterEvalQ(cl2,expr = {
    Rcpp::sourceCpp(("Riprova_corretta_W4.cpp"))
    source(("Riprova_correttaW4.R"))
