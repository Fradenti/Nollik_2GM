...
res1 <- readRDS("Grouped_model/LimmaProteomics_applicationHier/New_limma_pm3_th50_BI100k_W4.RDS")
res1$HP
...
PP1 <- 
  ...
  ylab("Density")+xlab("Observed z-score") 
PP1
ggsave("Grouped_model/Hier_Proteomics_1_th50_bi100k_W4.png",width = 15,height = 5)
ggsave("Grouped_model/Hier_Proteomics_1_th50_bi100k_W4.tiff",width = 15,height = 5)
ggsave("Grouped_model/Hier_Proteomics_1_th50_bi100k_W4.pdf",width = 15,height = 5)
...
PP2 <- 
  ...
  facet_wrap(~group)
PP2
ggsave("Grouped_model/LimmaProteomics_applicationHier/Hier_Proteomics_2_1_th50_bi100_W4.png",width = 15,height = 5)
ggsave("Grouped_model/LimmaProteomics_applicationHier/Hier_Proteomics_2_1_th50_bi100_W4.pdf",width = 15,height = 5)
ggsave("Grouped_model/LimmaProteomics_applicationHier/Hier_Proteomics_2_1_th50_bi100_W4.tiff",width = 15,height = 5)
